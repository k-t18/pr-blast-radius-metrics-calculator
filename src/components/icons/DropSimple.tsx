import { DropSimpleIcon } from '@phosphor-icons/react';
...
export default function DropSimple({ size = 20, color = 'currentColor' }: { size?: number; color?: string }) {
    return <DropSimpleIcon size={size} color={color} />;
}
