import { CaretDownIcon, type IconWeight } from '@phosphor-icons/react';
...
export default function CaretDown({ size = 20, color = 'currentColor', weight = 'regular' }: { size?: number; color?: string; weight?: IconWeight }) {
